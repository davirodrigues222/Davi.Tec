...
export const NovaOS: React.FC = () => {
  ...
  // Estado para armazenar os dados dinâmicos da Loja
  ...
  // Carrega as configurações salvas na Central de Configurações
  useEffect(() => {
    const configSalva =
  ...
  if (sucessoOS) {
    return (
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 text-center space-y-6 shadow-2xl print:hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 max-w-md mx-auto">
            <button
              ...
              className="py-3 px-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl text-xs transition flex items-center justify-center space-x-2"
            >
        ...
        {/* TEMPLATE DE IMPRESSÃO - DINÂMICO COM CENTRAL DE CONFIGURAÇÕES */}
